package com.wuliangzhu.config;

import com.wuliangzhu.service.CallbackFilter;
import com.wuliangzhu.service.CasRealm;
...
public class ShiroConfig {
    ...
    @Bean(name = "configRegistrationBean")
...
//        在登陆成功回调的时候进行验证
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager, Config config) {
        ...
        callbackFilter.setDefaultUrl(this.defaultUrl);
